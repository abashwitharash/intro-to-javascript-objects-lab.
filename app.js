...
game.party.push(pokemon[3], pokemon[11], pokemon[96]);
...
the Pokemon it evolved into. 
When working with an array of objects, the splice() array method is ideal 
...
game.party.splice(pokemon[25], 1, pokemon[25]);
console.log(game.party);
...
Solve Exercise 10 here:  Need to sync - no internet 
*/
...
Modify it so that it also decreases the number of pokeballs in your inventory each time you 
catch a Pokémon.
